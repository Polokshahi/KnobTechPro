        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {getVisibleReviews().map((review, idx) => (
            <div
              ...
              className="flex min-h-[260px] flex-col justify-between rounded-2xl border border-slate-200 bg-white p-7 shadow-sm transition-all duration-500 hover:-translate-y-1 hover:border-blue-200 hover:shadow-xl"
            >
              <div>
        ...
        {reviews.length > 3 && (
          <div className="mt-8 flex items-center justify-center gap-3">
            <button
              ...
              className="flex h-10 w-10 items-center justify-center rounded-full border border-slate-200 bg-white text-slate-600 shadow-sm hover:bg-blue-50 hover:text-blue-600"
            >
              <ChevronLeft size={18} />
            </button>
