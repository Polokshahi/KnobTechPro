  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="pt-32 pb-16 bg-slate-50 border-b border-slate-200 text-center">
        <h1 className="text-4xl font-bold">B2B Lead Generation</h1>
        <p className="text-slate-600 mt-2">Precision prospect research & custom ICP dataset building.</p>
      </div>
      <div className="py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-2xl font-bold mb-6">What We Deliver</h2>
        <div className="space-y-4 mb-12">
          {['ICP targeting & refinement', 'Decision-maker seniority filtering', 'Multi-tier email verification', 'CRM-ready CSV delivery'].map((item, i) => (
